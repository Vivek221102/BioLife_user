            ...
            <div className="banner-promotion">
                <div className="biolife-banner promotion5 biolife-banner__promotion5">
                    <div className="banner-contain" >
                        <div className="media">
                        <div className="text-content" style={{right: "6%", maxWidth: "600px", padding:"25px",backgroundColor:"#477890",opacity:"0.8",textAlign:"left",borderRadius:"25px" }}>
                           
                           
                           <b className="text2" style={{fontSize:"xxx-large", fontFamily:"sans-serif", color:"white"}}>Biolife-Store</b>
                          <span className="text2" style={{fontSize:"x-large", fontFamily:"serif", color:"white"}}>Welcome To Bio-Life store for make <b>"chance"</b> to earn amazing <b>Rewards</b> if you Buy Product By <b>OUR STORE</b> and after using Return that waste Product to <b>"Recycling"</b> it....   </span> 
                           <p className="buttons">
                               <Link to="/product" className="btn btn-bold" style={{color:"white"}}>Shop Now!</Link>
                           </p>
        ...
        <div class="advance-product-box">
            ...
            <div className="blog-posts background-fafafa sm-margin-top-33px sm-padding-top-75px sm-padding-bottom-80px xs-margin-top-30px xs-padding-top-30px xs-padding-bottom-50px">
                <div className="container">
                    ...
                    <ul className="biolife-carousel nav-center xs-margin-top-34px nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":3, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 3}},{"breakpoint":992, "settings":{ "slidesToShow": 2}},{"breakpoint":768, "settings":{ "slidesToShow": 2}},{"breakpoint":600, "settings":{ "slidesToShow": 1}}]}'>
                        <li>
                            <div className="post-item effect-01 style-bottom-info layout-03">
                                <div className="thumbnail">
                                    <Link to="#" className="link-to-post"><img src="assets/images/our-blog/post-thumb-04.jpg" width="370" height="270" alt=""/></Link>
                                ...
                                <div className="post-content">
                                    <h4 className="post-name"><Link to="#" className="linktopost">Ashwagandha: #1 Herb Anxiety?</Link></h4>
                                    <div className="post-meta">
                                        <p className="post-meta__item author">Posted By: <Link to="#" className="link-to-author">Mr.Braum</Link></p>
                                        <Link to="#" className="btn count-number liked"><i className="biolife-icon icon-heart-1"></i><span className="number">20</span></Link>
                                        <Link to="#" className="btn count-number commented"><i className="biolife-icon icon-conversation"></i><span className="number">06</span></Link>
                                    </div>
                                    <p className="excerpt">Did you know that red-staining foods are excellent lymph-movers? In fact, many plants...</p>
            ...
            <div className="newsletter-block layout-03 sm-margin-top-39px xs-margin-top-90px">
                <div className="container">
                    <div className="form-content">
                        ...
                        <p className="sub-title">and enjoy <b>25%</b> off your first purchase!</p>
            ...
            <Link className="btn-scroll-top"><i className="biolife-icon icon-left-arrow"></i></Link>
       </>
